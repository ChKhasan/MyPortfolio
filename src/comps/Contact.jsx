...
const Contact = () => {
  const form = useRef();
      ...
      const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_6c1gtbv', 'template_nhg8zfc', form.current,'KXRXxhdmhUS9nV40H')
          .then((result) => {
  ...
  return (
    <div className="container-fluid p-60" id="contact">
  ...
  <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
          ...
          <form ref={form} action="mailto:chulliyevhasan1499@mail.ru" onSubmit={sendEmail} method="post" role="form"  enctype="text/plain"  className="php-email-form">
              <div className="row">
